package com.example.yourvelociraptorflowers.ui.plants.addnewplants.adminadd;
...
import com.example.yourvelociraptorflowers.databinding.AddNewPlantAdminActivityBinding;
...
public class Add_new_plant extends AppCompatActivity {
    ...
    private AddNewPlantAdminActivityBinding binding;
    private FirebaseFirestore firestore;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = AddNewPlantAdminActivityBinding.inflate(getLayoutInflater());
    ...
    private void addPlant() {
        ...
        Integer koofesiant_poliva = Integer.parseInt(binding.editTextKoofesiantPoliva.getText().toString());
        Integer coefficient_illumination = Integer.parseInt(binding.editTextCoefficientIllumination.getText().toString());
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (queryDocumentSnapshots.isEmpty()) {
                        ...
                        Plants newPlant = new Plants(name,
                                ...
                                descriptionVlag,
                                descriptionVrsh,
                                descriptionUTUB, koofesiant_poliva, coefficient_illumination
                                );
                        firestore.collection("plants")
                                .add(newPlant)
                                ...
                                .addOnFailureListener(e -> {
                                    Toast.makeText(this, "Произошла ошибка при добавлении растения" + e, Toast.LENGTH_SHORT).show();
                                });
                    } else {
    ...
    private void clearFields() {
        ...
        binding.editTextKoofesiantPoliva.setText("");
        binding.editTextCoefficientIllumination.setText("");
    }
