package com.example.yourvelociraptorflowers.ui.plants.addnewplants.useradd;
...
import com.example.yourvelociraptorflowers.databinding.AddNewPlaintUserActivityBinding;
...
public class Add_new_plant_user extends AppCompatActivity {
    ...
    private AddNewPlaintUserActivityBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = AddNewPlaintUserActivityBinding.inflate(getLayoutInflater());
